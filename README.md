...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.16043153.svg)](https://doi.org/10.5281/zenodo.16043153)
...
**Keywords:** Migration, resource and habitat use, foraging, Apus apus, sky glow, light environment

## Use

Clone or download the project [zip file](https://github.com/bluegreen-labs/swift_CC894/archive/refs/heads/main.zip).

```bash
git clone https://github.com/bluegreen-labs/swift_CC894.git
```
...
Analysis data is saved as compressed R serial files (.rds) in the [`data` folder](https://github.com/bluegreen-labs/swift_CC894/tree/main/data).

## Licensing

Be mindful of the CC-BY 4.0 license of the figures/text, and the [Open Data Commons Open Database License (ODbL) v1.0](https://opendatacommons.org/licenses/odbl/1-0/) for the data itself. Reuse is permitted on the condition of proper attribution, documentation of any changes and resharing of the composite work under the same ODbL conditions.
